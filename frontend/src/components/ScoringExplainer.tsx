    ...
    <div style={{ fontSize: 13, color: 'var(--text2)' }}>
      <Section title="Overview">
        <p style={{ fontSize: 13, color: 'var(--text2)', lineHeight: 1.7, marginBottom: 10 }}>
          This is an <strong style={{ color: 'var(--text)' }}>async cross-country league</strong> — there's
          no mass start and no set flying day. Each task defines a route with GPS waypoints.
          You fly it whenever conditions allow during the open window, record the flight on
          any GPS logger or variometer, and upload the <strong style={{ color: 'var(--text)' }}>.igc file</strong> here.
        </p>
        <p style={{ fontSize: 13, color: 'var(--text2)', lineHeight: 1.7, marginBottom: 10 }}>
          The route is designed so that going further, faster gets more points — but every pilot
          earns points for how far they get, so it's worth flying even if goal feels out of reach.
        </p>
        <div style={{
          ...
          <strong style={{ color: '#4a9eff' }}>New to XC competition?</strong> Start with the task file
          — load it into XCTrack or a compatible app, fly as much of the route as you can,
          then upload your .igc track log when you land. That's it.
        </div>
      </Section>
      ...
      <Section title="Points">
        ...
        <div style={{
          ...
          <span style={{ color: 'var(--text2)', fontWeight: 600 }}>Total = Distance + Time.</span>{' '}
          Season standings sum your best result across all tasks. A missed task scores zero.
        </div>
        <div style={{
          ...
          <span style={{ color: 'var(--text2)', fontWeight: 600 }}>Normalization.</span>{' '}
          Some tasks have a maximum score set (e.g. 1000 pts). When normalization is on, the task winner's
          raw score is scaled to that maximum and every other pilot's score scales proportionally —
          so the relative gaps between pilots are preserved.
        </div>
      </Section>
      ...
      <Section title="Restarts">
        <div style={{ fontSize: 12, color: 'var(--text3)', lineHeight: 1.65 }}>
          You can re-cross the SSS cylinder as many times as you need. We automatically find the
          start that produced your furthest flight (or fastest time if you reached goal) and score that.
          All other attempts are discarded.
        </div>
      </Section>
    </div>
  );
