...
import { type CupPreviewTask, leagueApi } from '../api/leagues';
        ...
        {step === 'upload' && (
          <div>
            <p style={{ fontSize: '0.875rem', color: 'var(--text2)', marginBottom: '1.5rem' }}>
              Drop a SeeYou <strong>.cup</strong> waypoint file that contains a "Related Tasks" section. All tasks in
              the file will be detected and you can configure dates before importing.
            </p>
            <div
              onDragOver={(e) => {
                e.preventDefault();
